...
labellist = {
    "Anisotropic_Global": Anisotropy_Option,
    "Isotropic": Isotropic,
    "Flipped": sense,
...
def effective_velocity_annual_bilby(
    ...
    params_['s']        = s
    #
    params_['vism_ra1']  = vism_ra1           # (km s-1)
    params_['vism_dec1'] = vism_dec1          # (km s-1)
...
if Anisotropy_Option:
    ...
    if vism_ra_option:
        vism_ra1 = bilby.core.prior.Uniform(-300, 300, 'vism_ra1')
    ...
    if vism_dec_option:
        vism_dec1 = bilby.core.prior.Uniform(-300, 300, 'vism_dec1')
